<template>
  <transition name="fade">
    <div class="modal-wrapper" v-show="show">
      <div class="referral">
        <h1 class="referral__title">{{$t('other.refTerms')}}</h1>
        <div class="referral__container">
          <p class="referral__condition">Lorem ipsum dolor sit amet consectetur adipisicing elit. Deleniti minima, atque
            deserunt vitae pariatur delectus illo est, quibusdam culpa ut voluptatibus eos nihil corrupti rerum
            molestias quam odit sed at.Lorem ipsum dolor sit amet consectetur adipisicing elit. Deleniti minima, atque
            deserunt vitae pariatur delectus illo est, quibusdam culpa ut voluptatibus eos nihil corrupti rerum
            molestias quam odit sed at.Lorem ipsum dolor sit amet consectetur adipisicing elit. Deleniti minima, atque
            deserunt vitae pariatur delectus illo est, quibusdam culpa ut voluptatibus eos nihil corrupti rerum
            molestias quam odit sed at.Lorem ipsum dolor sit amet consectetur adipisicing elit. Deleniti minima, atque
