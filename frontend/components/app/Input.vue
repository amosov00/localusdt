<template lang="pug">
	div.input(:style="{width: `${width}px`}")
		div.input__box
			...
			input.input__field(@input="updateValue($event.target.value)" v-model="value" :value="value" :placeholder="placeholder" :type="showPasswordField" min="0" autocomplete="off")
