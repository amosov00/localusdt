  ...
  div.create-order
    ...
    div.create-order__form
      ...
      div.create-order__gap
        Input.mr-30(v-model="adForm.bot_limit" :width="200" type="number" header="Минимальный лимит транзакции")
        Input(v-model="adForm.top_limit" :width="200" type="number" header="Максимальный лимит транзакции")
